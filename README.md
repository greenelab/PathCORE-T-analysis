...
1. [run_network_creation.py](https://github.com/greenelab/PathCORE-analysis/blob/master/run_network_creation.py)
...
2. [run_permutation_test.py](https://github.com/greenelab/PathCORE-analysis/blob/master/run_permutation_test.py)
...
### Additional:
- [constants](https://github.com/greenelab/PathCORE-analysis/tree/master/constants)
  directory
...
- [utils.py](https://github.com/greenelab/PathCORE-analysis/blob/master/utils.py)
...
[analysis_Paeruginosa_eADAGE.sh](https://github.com/greenelab/PathCORE-analysis/blob/master/analysis_Paeruginosa_eADAGE.sh)
for `run_network_creation.py` ahead of the web application setup
carried out by running [web_db_Paeruginosa_eADAGE.sh](https://github.com/greenelab/PathCORE-analysis/blob/master/web_db_Paeruginosa_eADAGE.sh).

### Scripts (in order of execution):
- [web_initialize_db.py](https://github.com/greenelab/PathCORE-analysis/blob/master/web_initialize_db.py)
...
- [web_edge_page_data.py](https://github.com/greenelab/PathCORE-analysis/blob/master/web_edge_page_data.py)
...
### Additional:
- [utils_setup_PAO1_example.py](https://github.com/greenelab/PathCORE-analysis/blob/master/utils_setup_PAO1_example.py)
